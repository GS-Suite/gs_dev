...
async def post_announcement(classroom_uid: str = Body(...), announcement: str = Body(...), token: dict = Depends(token_validation)):
    return await announcement_routes.post_announcement(classroom_uid, announcement, token)