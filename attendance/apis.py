...
@router.post('/take_attendance/', tags = ["attendance : teacher"])
...
@router.post('/stop_attendance/', tags = ["attendance : teacher"])
...
@router.post('/give_attendance/', tags = ["attendance : student"])
